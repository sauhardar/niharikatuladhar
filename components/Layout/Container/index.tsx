...
export default function Container({ children, ...customMeta }: ContainerProps) {
  ...
  const meta = {
    title: "Niharika Tuladhar",
    description: 'Senior at Bates College, pursuing a B.A. in Political Science and Rhetoric with a minor in Philosophy.',
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Niharika Tuladhar" />
